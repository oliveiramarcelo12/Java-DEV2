...
public void exercicio7(){
    ...
    //percorrer o vetor e realizar as operaçoes de soma e multiplicaçao
    int soma=0;//acumular a soma dos elementos
    int mult= 1;//acumular a multiplicaçao dos elementos
    for (int i = 0; i < vetor.length; i++) {
        soma+=vetor[i]; //acumula a soma
        mult*=vetor[i]; //acumula a multiplicação
    }
    System.out.println("O valor da do vetor é"+soma);
